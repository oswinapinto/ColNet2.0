# code reference - https://github.com/ernestojimenezruiz/tabular-data-semantics-py/blob/master/TabularSemantics/src/kg/endpoints.py
'''
...
class SPARQLEndpoint(object):
    ...
    def getDistanceToAllSuperClasses(self, uri_class):
        ...
        query = self.createSPARQLQueryDistanceToAllSuperClassesForClass(
            uri_class)
    ...
    def getDistanceToAllSubClasses(self, uri_class, max_level=-1):
        ...
        query = self.createSPARQLQueryDistanceToAllSubClassesForClass(
            uri_class)
    ...
    def getPredicatesForSubject(self, subject_entity, limit=1000):
        ...
        query = self.createSPARQLQueryPredicatesForSubject(
    ...
    def getTypesUsingPredicatesForSubject(self, subject_entity, limit=1000):
        ...
        query = self.createSPARQLQueryDomainTypesOfPredicatesForSubject(
            subject_entity, limit)
    ...
    def getTypesUsingPredicatesForObject(self, obj_entity, limit=1000):
        ...
        query = self.createSPARQLQueryRangeTypesOfPredicatesForObject(
            obj_entity, limit)
    ...
    def getTopTypesUsingPredicatesForSubject(self, subject_entity, limit=5):
        ...
        query = self.createSPARQLQueryDomainTypesCountOfPredicatesForSubject(
            subject_entity, limit)
    ...
    def getTopTypesUsingPredicatesForObject(self, obj_entity, limit=5):
        ...
        query = self.createSPARQLQueryRangeTypesCountOfPredicatesForObject(
            obj_entity, limit)
