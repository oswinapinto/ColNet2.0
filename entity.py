# code reference - https://github.com/ernestojimenezruiz/tabular-data-semantics-py/blob/master/TabularSemantics/src/kg/entity.py
'''
...
class URI_KG(object):
    ...
    # Link to categories
    avoid_predicates.add("http://purl.org/dc/terms/subject")
    ...
    avoid_top_concepts.add(
        "http://www.wikidata.org/entity/Q35120")  # something
    avoid_top_concepts.add("http://www.wikidata.org/entity/Q830077")  # subject
    # item with given name property
    avoid_top_concepts.add("http://www.wikidata.org/entity/Q18336849")
    # individual/instance
    avoid_top_concepts.add("http://www.wikidata.org/entity/Q23958946")
    # subject of a right
    avoid_top_concepts.add("http://www.wikidata.org/entity/Q26720107")
    avoid_top_concepts.add("http://www.wikidata.org/entity/Q488383")  # object
    avoid_top_concepts.add(
        "http://www.wikidata.org/entity/Q4406616")  # concrete object
    avoid_top_concepts.add(
        "http://www.wikidata.org/entity/Q29651224")  # natural object
    avoid_top_concepts.add(
        "http://www.wikidata.org/entity/Q223557")  # physical object
    # natural physical object
    avoid_top_concepts.add("http://www.wikidata.org/entity/Q16686022")
...
class KGEntity(object):
    ...
    def __init__(self, enity_id, label, description, types, source):
        ...
        self.ident = enity_id
        self.label = label
        # sometimes provides a very concrete type or additional semantics
